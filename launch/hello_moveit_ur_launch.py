...
def generate_launch_description():
    ...
    #does not exist !! --> generated by chatGPT ....
    # Add the node to load the .scene file
    load_scene_node = Node(
        package="moveit_ros_perception",
        executable="load_octomap_and_meshes",
        name="load_scene",
        # Specify the path to your .scene file
        arguments=["/home/camillo/Documents/base_obstable_2.scene"],
        output="screen"
    )    
    
    demo_node = Node(
        package="hello_moveit",
        executable="hello_moveit_2",
        name="hello_moveit_2",
        output="screen",
        parameters=[
            robot_description,
